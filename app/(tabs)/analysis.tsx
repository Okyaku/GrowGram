...
const createStyles = () => {
  ...
  const panelBg = isLight ? theme.colors.white : "#0F2A4A";
  const panelBorder = isLight ? theme.colors.border : "#18345A";
  const segmentBg = isLight ? "#FFE8D4" : "#112342";
  const iconWrapBg = isLight ? "#FFF1E3" : "#173A61";
  const deltaPillBg = isLight ? "#E9F8F1" : "#173E2A";
  const rankCircleBg = isLight ? "#EEDFD2" : "#1D3559";
  ...
  return StyleSheet.create({
    ...
    rankCircle: {
      ...
      height: 28,
      borderRadius: 14,
      backgroundColor: rankCircleBg,
      alignItems: "center",
      justifyContent: "center",
    },
    rankCircle1: { backgroundColor: isLight ? "#D6B24B" : "#7A641C" },
    rankCircle2: { backgroundColor: isLight ? "#9CB2C9" : "#4A5F79" },
    rankCircle3: { backgroundColor: isLight ? "#BE9A86" : "#6E4738" },
    rankNumber: {
      color: theme.colors.text,
      fontWeight: "700",
      fontSize: 12,
